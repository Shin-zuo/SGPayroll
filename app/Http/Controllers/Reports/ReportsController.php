...
<<<<<<< HEAD
            ...
            if ($inactive->salary_status=='true') {
                $statutoryDues = (($inactive->basic_pay + $inactive->vacation_leave_amount + $inactive->sick_leave_amount) - ($inactive->annual_sss + $inactive->annual_phic + $inactive->annual_hdmf));
                $inactive_totalStatutory += $statutoryDues;
