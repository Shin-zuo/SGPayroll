...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td>Loans</td><td class="text-right">{{ number_format($payroll->sss_loan + $payroll->sss_calamity_loan + $payroll->hdmf_loan + $payroll->hdmf_calamity_loan + $payroll->other_loan + $payroll->sss_emergency_loan, 2) }}</td>
        </tr>
        <tr>
